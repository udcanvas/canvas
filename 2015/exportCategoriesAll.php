...
$query=sprintf("SELECT g.groupnum, e.evaluator, e.evaluatee, e.custom FROM `evaluation` e, glue g WHERE e.surveyid=%d and e.evaluator<>%d and g.surveyid=e.surveyid and g.udid=e.evaluatee  order by g.groupnum",$projectid,$_GET['facid']);
